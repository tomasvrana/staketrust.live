  ...
  render () {
    ...
    return (
      <Container ref={this.containerRef}>
        <Navigate left navigationBackgroundColor={this.props.navigationBackgroundColor}>
          <Link tracking={{ label: `carousel_navigate_left_${this.props.name}` }} href='#' onClick={this.navigate('left')}>
            <div>
              <Arrow left fill />
            </div>
          </Link>
        </Navigate>
        <Navigate right navigationBackgroundColor={this.props.navigationBackgroundColor}>
          <Link tracking={{ label: `carousel_navigate_right_${this.props.name}` }} href='#' onClick={this.navigate('right')}>
            <div>
              <Arrow right fill />
            </div>
          </Link>
